"""pipe.lib.legal — atomic legal operations, jurisdiction-aware.
...
registry. Ops are atomic — compose them with ``>>`` when you want a pipeline.
    ...
    from pipe.lib.legal import DetectPII, Redact
    pii = DetectPII("us/ny")
...
from pipe.lib.legal.catalog import RULES, categories
from pipe.lib.legal.operations import (
    DetectPII,
    ExtractCitations,
    IdentifyStatutes,
    Redact,
